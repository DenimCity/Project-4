...
router.get('/la', async(request, response) => {
 axios
    .get(`https://api.meetup.com/find/groups?key=${process.env.EVENT_KEY}&photo-host=public&location=los+angeles&page=3&sig_id=245595678&sig=3794f40556d38e63ff33b89439c6aa52680d9cbb`)
    .then((response)=> {
      return response.data
    }).then((la)=> {
      response.json(la)
